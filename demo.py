...
class Config(object):
    def __init__(self):
        ...
        # demo image
        parser.add_argument('--demo_image', type=str, default='/home/thulab/Desktop/pedestrian-attribute-recognition-pytorch/dataset/demo/14.jpg')
        ## dataset parameter
        ...
        parser.add_argument('--model_weight_file', type=str, default='/home/thulab/Desktop/pedestrian-attribute-recognition-pytorch/exp/deepmar_resnet50/pa100k/partition0/run1/model/ckpt_epoch150.pth')
...
for idx in range(len(cfg.att_list)):
    if score[0, idx] >= 0:
        ...
        positive_cnt += 1
img.save('./dataset/demo/demo_image_result1.jpg')
