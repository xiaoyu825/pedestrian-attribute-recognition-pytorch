...
def generate_data_description(save_dir):
    ...
    dataset['root'] = '/home/thulab/Desktop/pedestrian-attribute-recognition-pytorch/dataset/pa100k/data/'
    dataset['image'] = []
    dataset['att'] = []
    dataset['att_name'] = []
    dataset['selected_attribute'] = range(26)
    # load ANNOTATION.MAT
    data = loadmat('/home/thulab/Desktop/pedestrian-attribute-recognition-pytorch/dataset/pa100k/annotation.mat')
    for idx in range(26):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--save_dir',
        type=str,
        default='/home/thulab/Desktop/pedestrian-attribute-recognition-pytorch/dataset/pa100k/')
    parser.add_argument(
        '--traintest_split_file',
        type=str,
        default="/home/thulab/Desktop/pedestrian-attribute-recognition-pytorch/dataset/pa100k/pa100k_partition.pkl")
